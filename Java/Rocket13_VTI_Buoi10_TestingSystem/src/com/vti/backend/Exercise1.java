...
public class Exercise1 {
	...
	public void question2() throws ClassNotFoundException, SQLException {
		...
		while(posResult.next()) {
			System.out.format(leftAlignFormat, posResult.getInt(1), posResult.getNString(2));
		}
		System.out.format("+--------+-----------------------+%n");
	}
	...
	public void question4() throws ClassNotFoundException, SQLException {
		...
		String sql = "UPDATE position SET PositionName = ? WHERE"
				+ "(PositionID = ?)";
		PreparedStatement preQues4 = jdbc.createPrepareStatement(sql);
		preQues4.setString(1, newName);
		preQues4.setInt(2, id);
		if(preQues4.executeUpdate() == 1) {
	...
	public void question5() throws ClassNotFoundException, SQLException {
		...
		PreparedStatement preQues5 = jdbc.createPrepareStatement(sql);
		preQues5.setInt(1, id);
		if(preQues5.executeUpdate() == 1) {
